...
class _OnboardingScreenState extends State<OnboardingScreen> with TickerProviderStateMixin {
  ...
  bool _canProceed() {
    switch (_currentPage) {
      // case 5: return _onboardingData.noteFrequency != null; // REMOVED: noteFrequency field no longer exists
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // NOTE: noteFrequency field was removed from OnboardingData in redesign
          // The following cards are kept for reference but won't work without the field
          OnboardingQuestionCard(
            emoji: '📝',
            title: 'Daily',
            subtitle: 'I\'m committed',
            isSelected: false, // _onboardingData.noteFrequency == 'daily',
          ...
          OnboardingQuestionCard(
            ...
            isSelected: false, // _onboardingData.noteFrequency == 'weekly',
          ...
          OnboardingQuestionCard(
            ...
            subtitle: 'As needed',
            isSelected: false, // _onboardingData.noteFrequency == 'occasional',
